...
function ScreenHelp:draw()
	...
	love.graphics.setColor(255, 255, 255, 255)
	love.graphics.printf("Try clicking pixels of a same color in a row to not only rack up more points per pixel destroyed, but also add a sweet splash effect and destroy more pixels at once!", 332, 256, 256, "right");
	love.graphics.rectangle("fill", 140, 260, 8, 8)
	love.graphics.setFont(fonts.standard)
	love.graphics.printf(self.splashsize, 150, 261, 8, "center")
	love.graphics.setFont(fonts.big)
	particles:draw()
