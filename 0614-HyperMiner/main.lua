...
function love.load()
	Probe.new({name = "Probe", x = 0, y = 1024, v = 8.5, dir = math.pi*1.5, mass = 1, size = 8, active = true})
	
	-- Test environment
	-- A planetary system with two moons around it
	-- Also some asteroids and a comet around
	Planet.new({name = "Terra", x = 1024, y = 1024, v = 0, dir = 0, vrot = math.pi/8, mass = 128, size = 256, atmosphere = {H=0.1, O=0.6, H20=0.3}, atmosphere_size = 320,
		texture = { {"gradient", {64, 128, 144, 255}, {12, 64, 96, 255}, 50}, {"scatter", {0, 0, 128, 128}, 0.8}, {"blotch", {0, 64, 0, 204}, 8, 0.8} } })
	Body.new({class = 2, name = "Luna", x = 1024, y = 1024 + 640, v = 14, dir = 0, vrot = -math.pi/16, mass = 24, size = 16,
		texture = { {"gradient", {128, 32, 32, 255}, {72, 0, 0, 255}, 32}, {"scatter", {0, 0, 0, 128}, 0.5} } })
	Body.new({class = 2, name = "Selena", x = 64, y = 1024, v = 11.5, dir = math.pi*0.5, vrot = math.pi/64, mass = 48, size = 32,
		texture = { {"gradient", {192, 128, 144, 255}, {128, 108, 128, 255}, 50}, {"blotch", {64, 64, 64, 64}, 4, 0.8}, {"blotch", {0, 0, 64, 64}, 3, 0.9} } })
